...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'aerial_ship_saml_sp.bridge.binding_manager' => 'getAerialShipSamlSp_Bridge_BindingManagerService',
            ...
            'security.firewall.map.context.saml' => 'getSecurity_Firewall_Map_Context_SamlService',
    ...
    /**
     * Gets the 'aerial_ship_saml_sp.bridge.binding_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return AerialShip\SamlSPBundle\Bridge\BindingManager A AerialShip\SamlSPBundle\Bridge\BindingManager instance.
     */
    protected function getAerialShipSamlSp_Bridge_BindingManagerService()
    {
        return $this->services['aerial_ship_saml_sp.bridge.binding_manager'] = new \AerialShip\SamlSPBundle\Bridge\BindingManager();
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $f->addDriver($e, 'AerialShip\\SamlSPBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('NasajonCalendarioBundle' => 'Nasajon\\CalendarioBundle\\Entity', 'AerialShipSamlSPBundle' => 'AerialShip\\SamlSPBundle\\Entity'));
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.saml' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    /**
     * Gets the 'security.firewall.map.context.saml' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_SamlService()
    {
        ...
        $f = $this->get('kernel');
        $g = $this->get('session');
        $h = $this->get('aerial_ship_saml_sp.bridge.binding_manager');
        $i = $this->get('doctrine.orm.default_entity_manager');
        $j = $this->get('security.authentication.manager');
        ...
        $n = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($l, array('login_path' => '/saml/sp/login', 'target_path_parameter' => '_target_path', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'use_referer' => false));
        $n->setProviderKey('saml');
        ...
        $r = new \AerialShip\SamlSPBundle\Config\SpMetaConfigProvider(array('name_id_format' => 'persistent', 'binding' => array('authn_request' => 'redirect', 'response' => 'post', 'logout_request' => 'redirect')));

        $s = new \AerialShip\SamlSPBundle\Config\ServiceInfo('saml', 'nasajon_calendario', $p, $q, $r, $o);

        $t = new \AerialShip\SamlSPBundle\Config\ServiceInfoCollection();
        $t->add($s);

        $u = new \AerialShip\SamlSPBundle\State\Request\SessionStore($g, 'saml');

        $v = new \AerialShip\SamlSPBundle\Entity\SSOStateStoreManager($i, 'Nasajon\\CalendarioBundle\\Entity\\SSOState');

        $w = new \AerialShip\SamlSPBundle\RelyingParty\RelyingPartyCollection();
        $w->append(new \AerialShip\SamlSPBundle\Bridge\LogoutReceiveResponse($h, $u, $t, $v, $b, $l));
        $w->append(new \AerialShip\SamlSPBundle\Bridge\LogoutReceiveRequest($h, $v, $t, $l));
        $w->append(new \AerialShip\SamlSPBundle\Bridge\LogoutSendRequest($b, $t, $u));
        $w->append(new \AerialShip\SamlSPBundle\Bridge\LogoutFallback($l));

        $x = new \AerialShip\SamlSPBundle\RelyingParty\RelyingPartyCollection();
        $x->append(new \AerialShip\SamlSPBundle\Bridge\Discovery(NULL, $t, $this->get('templating'), $l));
        $x->append(new \AerialShip\SamlSPBundle\Bridge\FederationMetadata($t, $l));
        $x->append(new \AerialShip\SamlSPBundle\Bridge\Authenticate($t, $u, $l, $h));
        $x->append(new \AerialShip\SamlSPBundle\Bridge\AssertionConsumer($h, $t, $u, $v));
        $x->append($w);
        $x->append(new \AerialShip\SamlSPBundle\Bridge\SSOSessionCheck('saml', $b, $v, $l));
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('saml', '/logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'NasajonCalendarioBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'NasajonCalendarioBundle' => 'Nasajon\\CalendarioBundle\\NasajonCalendarioBundle',
                'BraincraftedBootstrapBundle' => 'Braincrafted\\Bundle\\BootstrapBundle\\BraincraftedBootstrapBundle',
                'JMSGoogleClosureBundle' => 'JMS\\GoogleClosureBundle\\JMSGoogleClosureBundle',
                'AerialShipSamlSPBundle' => 'AerialShip\\SamlSPBundle\\AerialShipSamlSPBundle',
            ...
            'aerial_ship_saml_sp.state.store.sso.entity_class' => 'Nasajon\\CalendarioBundle\\Entity\\SSOState',
