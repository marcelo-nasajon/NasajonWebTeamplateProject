...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/Sistemas/Workspace/symfony/app/cache/dev/assetic/config'), true)));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_ad6b6c2768ede2dfc91ab46a3c899f3a77179a1cbd4873b027b533aef1d656bf');
        ...
        $d->setProxyDir('C:/Sistemas/Workspace/symfony/app/cache/dev/doctrine/orm/Proxies');
